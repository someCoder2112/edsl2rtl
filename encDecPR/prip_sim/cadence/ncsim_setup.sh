...
TOP_LEVEL_NAME="prip"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/dmas02/altera/16.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/alt_pr/alt_pr.v" -work prip -cdslib ./cds_libs/prip.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/prip.vhd"                                                  
fi
